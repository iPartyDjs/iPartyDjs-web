...
import "@/styles/legacy/WeddingExperiences.css";
            ...
            <div className="wedding-experiences__inner">
                ...
                >
                    <h2 className="we-header__title">
                        Experiencias de
                        <br />
                        <span className="we-header__title-accent">
                            Bodas de Autor
                        </span>
                    </h2>
                    <p className="we-header__subtitle">
                        Más que servicios adicionales, diseñamos experiencias
                        que transforman cada momento de tu boda en algo
