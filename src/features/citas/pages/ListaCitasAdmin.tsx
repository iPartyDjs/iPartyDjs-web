        ...
        <>
            <div className="ipdj-main-header">
                <div>
                    <h2>Citas</h2>
                    <p>
                        Administra y reprograma las citas agendadas con
                        clientes.
                    </p>
                </div>
                <button
            ...
            <div className="ipdj-table-wrap">
                ...
                <div className="ipdj-table-footer">
                    <div className="count">
                        ...
                        {"–"}
                        {(currentPage - 1) * PAGE_SIZE +
                            paginated.length} de {filtered.length} citas
                    </div>
            ...
            <div className="ms-modal" onClick={(e) => e.stopPropagation()}>
                <div className="ms-modal-header">
                    <div>
                        ...
                        >
                            Se creará una nueva cita y la actual quedará marcada
                            como cancelada.
                        </p>
                    </div>
                    <button
                ...
                >
                    ...
                    <div className="ipdj-field">
                        <label htmlFor="reagendar-fecha_hora">
                            Nueva fecha y hora
                        </label>
                        <input
                    ...
                    <div className="ipdj-field">
                        <label htmlFor="reagendar-enlace">
