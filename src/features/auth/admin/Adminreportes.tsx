...
export default function AdminReportes() {
    const kpis = useMemo(() => {
        const totalReservas = RESERVAS_POR_TIPO.reduce(
            (a, p) => a + p.reservas,
            0,
        );
        ...
        const aceptadas =
            SOLICITUDES_POR_ESTADO.find((p) => p.key === "aceptada")?.valor ??
            0;
    ...
    return (
        <AdminPageShell topbarTitle="Reportes">
            <div className="ipdj-rep-printable">
                ...
                <div className="ipdj-rep-print-header">
                    ...
                    <span className="ipdj-rep-print-meta">
                        Reporte de administración · Generado el{" "}
                        {fechaGeneracion}
                    </span>
                </div>
