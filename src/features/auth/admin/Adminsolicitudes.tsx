...
export default function AdminSolicitudes() {
    ...
    const [confirmingReject, setConfirmingReject] = useState<string | null>(
        null,
    );
            ...
            sidePanel={
                seleccionada ? (
                    <PanelDetalleSolicitud
                        ...
                        onAprobar={() =>
                            approveMutation.mutate(seleccionada.id_solicitud)
                        }
                        onRechazar={() =>
                            handleReject(seleccionada.id_solicitud)
                        }
                        onCompletar={() =>
                            completeMutation.mutate(seleccionada.id_solicitud)
                        }
                        confirmandoRechazo={
                            confirmingReject === seleccionada.id_solicitud
                        }
                        cargando={
