        ...
        <>
            ...
            <div className="ipdj-field">
                ...
                <input
                    ...
                    value={displayEvento}
                    onChange={(e) =>
                        handleDraftChange("evento", e.target.value)
                    }
                />
            </div>
            <div className="ipdj-field-row">
                <div className="ipdj-field">
                    ...
                    <input
                        ...
                        value={displayFecha}
                        onChange={(e) =>
                            handleDraftChange("fecha", e.target.value)
                        }
                    />
                </div>
                <div className="ipdj-field">
                    ...
                    <input
                        ...
                        value={displayHora}
                        onChange={(e) =>
                            handleDraftChange("hora", e.target.value)
                        }
                    />
                </div>
            </div>
            ...
            <div className="ipdj-field">
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleDraftChange("ubicacion", e.target.value)
                    }
                />
            </div>
            <div className="ipdj-field">
