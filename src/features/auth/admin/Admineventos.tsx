...
export default function AdminEventos() {
  ...
  // Handlers de filtros: cada uno actualiza su propio estado y resetea la
  // página a 1 en el mismo evento, para no quedar en una página que ya
  // no existe con el nuevo conjunto filtrado.
  ...
  function handleCategoryFilterChange(
    value: "Todas" | EventoDTO["tipo_evento"],
  ) {
  ...
  async function saveChanges() {
    ...
    if (draft.fecha_hora !== undefined && draft.fecha_hora !== null) {
      ...
      payload.fecha_hora =
        fechaValue instanceof Date ? fechaValue : new Date(String(fechaValue));
    }
            ...
            return (
              ...
              >
                {/* Sin placeholder de imagen: EventoDTO no tiene campo de
                    ...
                    position: absolute en el CSS (pensado para un thumb que
                    ya no existe) y sin esto salen disparados a las
      ...
      {selected.estado === "realizado" && (
        ...
        >
          ...
          {!loadingResenia && !resenia && (
            <div className="cell-muted">Este evento aún no tiene reseña.</div>
          )}
          ...
          {!loadingResenia && resenia && (
            <>
              ...
              {resenia.comentario_edicion && (
                ...
                >
                  Edición solicitada: {resenia.comentario_edicion}
                </p>
              )}
              ...
              {resenia.estado === "aprobado" && !reseniaEdicionPendiente && (
                <button
                  className="ipdj-btn-danger"
