...
const EVENTS: EventTypeRecord[] = [
    {
        ...
        category: "Bodas",
        description:
            "Paquete completo con DJ, iluminación y pista de baile LED.",
        priceFrom: 12000,
        durationHours: 6,
        bookings: 18,
        active: true,
    ...
    },
    {
        ...
        description:
            "Ambientación musical profesional para eventos de empresa.",
        priceFrom: 9000,
        durationHours: 4,
        bookings: 9,
        active: true,
    ...
    },
    {
        ...
        category: "Cumpleaños",
        description:
            "DJ + juegos de luces básicos, ideal para fiestas en casa.",
        priceFrom: 4500,
        durationHours: 3,
        bookings: 31,
        active: true,
...
export default function AdminEventos() {
    ...
    const [categoryFilter, setCategoryFilter] = useState<"Todas" | string>(
        "Todas",
    );
    ...
    function handleDraftChange<K extends keyof EventTypeRecord>(
        key: K,
        value: EventTypeRecord[K],
    ) {
    ...
    function saveChanges() {
        setEvents((prev) =>
            prev.map((e) => (e.id === selected.id ? { ...e, ...draft } : e)),
        );
        setDraft({});
    }
        ...
        <>
            <div className="ipdj-main-header">
                <div>
                    <h2>Eventos</h2>
                    <p>
                        Administra los tipos de evento y paquetes que ofrece la
                        plataforma.
                    </p>
                </div>
                <button className="ipdj-btn-gold">
                ...
                {filtered.slice(0, PAGE_SIZE).map((e) => (
                    ...
                    >
                        <div className="ipdj-event-thumb">
                            ...
                            {!e.active && (
                                <span className="ipdj-event-inactive-badge">
                                    Inactivo
                                </span>
                            )}
                        </div>
                        <div className="ipdj-event-info">
                            ...
                            <div className="event-meta">
                                <span className="event-price">
                                    Desde {formatMXN(e.priceFrom)}
                                </span>
                                <span className="event-duration">
                                    {e.durationHours} hrs
                                </span>
                                <span className="event-bookings">
                                    {e.bookings} reservas
                                </span>
                            </div>
                        </div>
    ...
    const sidePanel = (
        <>
            ...
            <div className="ipdj-event-preview">
                ...
                {!displayActive && (
                    <span className="ipdj-event-inactive-badge">Inactivo</span>
                )}
            </div>
            ...
            <div className="ipdj-field ipdj-field-toggle">
                ...
                <label className="ipdj-toggle">
                    <input
                        ...
                        onChange={(e) =>
                            handleDraftChange("active", e.target.checked)
                        }
                    />
                    <span className="ipdj-toggle-slider" />
                </label>
                <span className="ipdj-toggle-label">
