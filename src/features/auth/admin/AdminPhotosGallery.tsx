...
export default function AdminPhotosGallery() {
    ...
    const [draftDescripcion, setDraftDescripcion] = useState<string | null>(
        null,
    );
    ...
    // Bloqueo de UI: el colaborador fotográfico no puede eliminar fotografías.
        ...
        <>
            ...
            <div className="ipdj-filters">
                ...
                <select
                    ...
                    onChange={(e) => {
                        setStatusFilter(
                            e.target.value as "Todos" | EstadoFotografia,
                        );
                        setCurrentPage(1);
                    }}
                >
            ...
            {fotosQuery.isLoading ? (
                ...
                >
                    ...
                    {getErrorMessage(fotosQuery.error)} (si tu cuenta es
                    "administrador" en vez de "superadministrador", este módulo
                    no está en tu alcance de permisos — solo superadmin tiene
                    FOTOGRAFIA:*)
                </p>
            ) : viewMode === "table" ? (
                <div
                    ...
                    {paginatedPhotos.map((p) => (
                        ...
                        >
                            <div className="ipdj-photo-thumb">
                                ...
                                <span
                                    className={
                                        STATUS_CLASS[resolveEstado(p.estado)]
                                    }
                                >
            ...
            {!fotosQuery.isLoading && !fotosQuery.isError && (
                <div className="ipdj-table-footer">
                    <div className="count">
                        ...
                        al {Math.min(currentPage * PAGE_SIZE, filtered.length)}{" "}
                        de {filtered.length} fotografías
                    </div>
