...
export default function AdminLogin() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Permitimos también al colaborador fotográfico acceder al panel, pero
            // con acceso limitado (solo la sección de Fotografías).
            if (
                ![
                    "administrador",
                    "superadministrador",
            ...
            // Redirigir al colaborador fotográfico directamente a Fotografías.
            if (userRole === "colaborador_fotografico") {
                navigate("/dashboard/admin/fotografias");
            } else {
            ...
            <div className="admin-login-content">
                ...
                <p className="admin-footnote">
                    ...
                    <Link to="/login" className="admin-link">
                        Ir al inicio de sesión de clientes
                    </Link>
                </p>
            </div>
        </div>
