        ...
        <div className="profile-page">
                    ...
                    <div className="profile-form-grid">
                        ...
                        <div className="profile-field">
                            ...
                            <input
                                ...
                                value={profile.phone}
                                onChange={(e) =>
                                    handleProfileField("phone", e.target.value)
                                }
                                className={
                        ...
                        <div className="profile-field profile-field--full">
                            ...
                            <input
                                ...
                                value={profile.city}
                                onChange={(e) =>
                                    handleProfileField("city", e.target.value)
                                }
                                className={
                        ...
                        <div className="profile-field">
                            ...
                            <div className="profile-input-icon">
                                <input
                                    ...
                                    className={
                                        passwordErrors.next ? "is-invalid" : ""
                                    }
                                />
                                <button
                                    type="button"
            ...
            <section className="profile-card fade-up">
                <div className="profile-card-header">
                    ...
                    <p>
                        Elige cómo quieres que te avisemos sobre tus solicitudes
                        y citas.
                    </p>
                </div>
                ...
                <div className="profile-toggle-list">
                    ...
                    <ToggleRow
                        ...
                        onChange={() =>
                            handleTogglePref("whatsappNotifications")
                        }
                    />
                    <ToggleRow
